...
csv_filename = "object_coordinates.csv"
csv_header = ["Timestamp", "X-coordinate"]
with open(csv_filename, mode='w') as csv_file:
    writer = csv.writer(csv_file, delimiter=',')  # Set delimiter to comma
...
def robot_control(cx, cy, area_biggest):
    ...
    # Append elapsed time and X-coordinate to CSV file
    with open(csv_filename, mode='a') as csv_file:
        writer = csv.writer(csv_file, delimiter=',')  # Set delimiter to comma
        writer.writerow([elapsed_time_str, cx])
